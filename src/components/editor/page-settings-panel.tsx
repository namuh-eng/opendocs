      ...
      <div className="p-4 space-y-4">
        <SettingsField label="Title">
          <input
            ...
            onBlur={handleSave}
            className="w-full px-3 py-1.5 bg-[#1a1a1a] border border-white/[0.08] rounded-md text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-[var(--od-accent)]"
          />
        </SettingsField>
        ...
        <SettingsField label="Slug">
          <input
            ...
            onBlur={handleSave}
            className="w-full px-3 py-1.5 bg-[#1a1a1a] border border-white/[0.08] rounded-md text-sm text-gray-400 placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-[var(--od-accent)]"
          />
        </SettingsField>
